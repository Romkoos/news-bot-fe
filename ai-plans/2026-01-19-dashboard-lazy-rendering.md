...
- [ ] Step 1: Add `shared/ui/lazy-mount` primitive (IntersectionObserver-based)
- [ ] Step 2: Extend `entities/digest/ui/DigestCardList` to support lazy-mounting after N items
